...
### Что такое JVM? Почему Java называется платформонезависимым языком программирования?

Виртуальная машина Java (JVM) это процесс, который может выполнять Java байткод. Каждый исходный Java файл компилируется в файл байткода, который выполняется JVM. Java была разработана таким образом, что бы приложения могли выполняться на любой платформе, без необходимости переписываться или перекомпилироваться программистом для каждой платформы. Благодаря виртуальной машине Java это возможно, потому что она принимает во внимание специфические длины инструкций и другие особенности используемого аппаратного обеспечения платформы.
